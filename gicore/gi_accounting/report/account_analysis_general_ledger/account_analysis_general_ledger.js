...
frappe.query_reports["Account Analysis General Ledger"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		},
		{
			...
			description: __("Selecting a node also includes all of its child nodes"),
		},
		{
...
erpnext.utils.add_dimensions("Account Analysis General Ledger", 15);
